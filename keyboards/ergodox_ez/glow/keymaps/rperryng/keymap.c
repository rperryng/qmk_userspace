...
const uint16_t PROGMEM dqt_combo[] = {KC_R, KC_T, COMBO_END};
const uint16_t PROGMEM sqt_combo[] = {KC_N, KC_I, COMBO_END};
combo_t key_combos[] = {
    COMBO(esc_combo, KC_ESC),
    COMBO(dqt_combo, KC_DQT),
    COMBO(sqt_combo, KC_QUOT),
};
...
//    │             │  k  │  h  │    ,    │  .  │  /  │     │                                       │     │  z  │  x  │  c  │      d      │      v      │             │
//    ├─────────────┼─────┼─────┼─────────┼─────┼─────┴─────┘                                       └─────┴─────┼─────┼─────┼─────────────┼─────────────┼─────────────┤
//    │ MO(LA_SYMB) │ spc │     │         │     │                                                               │     │     │ TO(LA_MOUS) │ MO(LA_NAVI) │ MO(LA_SYMB) │
//    └─────────────┴─────┴─────┴─────────┴─────┘                 ┌─────┬─────┐   ┌─────┬─────┐                 └─────┴─────┴─────────────┴─────────────┴─────────────┘
//                                                                │     │     │   │     │     │
//                                                                └─────┼─────┤   ├─────┼─────┘
//                                                                      │     │   │     │
...
[LA_BASE] = LAYOUT_ergodox_pretty(
  _______     , _______ , _______ , CW_TOGG  , _______ , _______ , _______ ,                                                                 _______ , _______ , _______ , _______ , _______     , _______     , _______    ,
  ...
  MO(LA_SYMB) , KC_SPC  , _______ , _______  , _______ ,                                                                                                         _______ , _______ , TO(LA_MOUS) , MO(LA_NAVI) , MO(LA_SYMB),
...
[LA_SYMB] = LAYOUT_ergodox_pretty(
  ...
  _______ , _______ , _______ , _______ , _______ , _______ , _______ ,                                                                 _______ , _______ , KC_PIPE , KC_MINS , KC_EQL  , KC_PLUS    , _______,
  _______ , _______ , OS_CMD  , OS_ALT  , OS_CTRL , OS_SHFT ,                                                                                     KC_LPRN , KC_RPRN , KC_LCBR , KC_RCBR , KC_UNDS    , _______,
  _______ , KC_TILD , KC_GRV  , KC_QUOT , KC_DQT  , KC_BSLS , _______ ,                                                                 _______ , KC_LBRC , KC_RBRC , KC_LT   , KC_GT   , _______    , _______,
  _______ , _______ , _______ , _______ , _______ ,                                                                                                         _______ , _______ , _______ , MO(LA_NUM) , _______,
                                                                                  _______ , _______ ,     _______ , _______                                                                                   ,
                                                                                            _______ ,     _______                                                                                             ,
                                                                        _______ , _______ , _______ ,     _______ , _______ , _______
),
...
//    ├────────────┼──────┼──────┼─────┼──────┼─────┼─────┐                                       ┌─────┼─────────┼─────────┼────────┼────────┼─────┼────────────┤
//    │            │ home │ ent  │ esc │ end  │     │     │                                       │     │         │ SW_CTRL │ SW_ALT │ SW_WIN │     │            │
//    ├────────────┼──────┼──────┼─────┼──────┼─────┴─────┘                                       └─────┴─────────┼─────────┼────────┼────────┼─────┼────────────┤
//    │ MO(LA_NUM) │      │      │     │      │                                                                   │         │        │        │     │ MO(LA_NUM) │
//    └────────────┴──────┴──────┴─────┴──────┘                 ┌─────┬─────┐   ┌─────┬─────┐                     └─────────┴────────┴────────┴─────┴────────────┘
//                                                              │     │     │   │     │     │
...
[LA_NAVI] = LAYOUT_ergodox_pretty(
  ...
  _______    , KC_HOME , KC_ENTER , KC_ESC  , KC_END   , _______ , _______ ,                                                                 _______ , _______ , SW_CTRL , SW_ALT  , SW_WIN  , _______ , _______   ,
...
[LA_NUM] = LAYOUT_ergodox_pretty(
  ...
  _______ , KC_CIRC , KC_AMPR , KC_ASTR , _______ , _______ ,                                                                                     KC_EXLM , KC_AT   , KC_HASH , KC_DLR  , KC_PERC , _______,
